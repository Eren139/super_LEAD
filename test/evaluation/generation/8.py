...
client = OpenAI(
    ...
    api_key="sk-oVYqyJnoyElCqn4v34A24389DcFf46A4A1EbE4C5FdF2930d"
)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--wraped_file", default=r'D:\code\Superfiltering-main\test\scripts\logs\ifd_sim_dir-VS-ifd_dir\sinstruct_wrap.json')
    parser.add_argument("--api_key", type=str, default='sk-oVYqyJnoyElCqn4v34A24389DcFf46A4A1EbE4C5FdF2930d')
    parser.add_argument("--api_model", type=str, default='gpt-3.5-turbo')
    parser.add_argument("--api_base", type=str, default='https://api.gpts.vin/v1')
    parser.add_argument(
        "--batch_size",
        type=int,
        default=1,
